...
- 前のAIカリキュラムの最終成果物を、次章で `engineer-design.md` として配置できる状態にする
...
このカリキュラムでは、Sourcetree の画面ラベルを **英語表記ベース** で書いています。  
...
**できた状態**：前カリキュラムの最終成果物を見返せる状態で、次章ですぐ使える。
...
- [ ] 前AIカリキュラムの最終成果物を、次章ですぐ使える状態にできた
