...
- 前のAIプログラムの最終成果物を、次章で `engineer-design.md` として配置できる状態にする
...
このGitプログラムでは、前のAIプログラムで作成した **自分のエンジニア設計書** を使って練習します。

1. クローンしたフォルダをお使いのエディタで開く
2. 前のAIプログラムで作った最終成果物を開く
3. 次章ですぐ貼り付けられるように、内容を見返せる状態にしておく
...
次章で `feature/02-first-commit` を作ってから、`engineer-design.md` の追加を最初のコミットとして残します。

**できた状態**：前プログラムの最終成果物を見返せる状態で、次章ですぐ使える。
...
- [ ] 前AIプログラムの最終成果物を、次章ですぐ使える状態にできた
...
環境構築が完了したら、進捗ダッシュボードで **完了日** を記録してください。
