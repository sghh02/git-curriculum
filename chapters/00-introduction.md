...
[ここに「main / develop / feature」の図解を挿入]
...
[ここに「質問テンプレ」をメモしている画面のスクリーンショットを挿入]
...
## 7. AIに聞いてみよう（質問例）
- 「Sourcetree で“ステージング”と“コミット”の違いを、提出に例えて説明して」
- 「`Permission denied (publickey)` が出た。Sourcetree と GitHub のどこを確認すればいい？」
- 「PR（Pull Request）の説明文を、初心者でも書けるテンプレにして」
